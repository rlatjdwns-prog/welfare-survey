...
const COMPANY_DEFAULT = {
  ...
  features: [
    { icon: "🤝", title: "동료지원", desc: "동료지원인 양성교육 · 동료상담 · 동료지원인 역량강화" },
    { icon: "🌿", title: "자립지원", desc: "개인별자립지원 · 자조모임" },
    { icon: "📢", title: "권익옹호", desc: "인권증진활동(정신건강교육, 옴부즈맨) · 인식개선행사(전시회, 지역사회행사, 캠페인)" },
    { icon: "👥", title: "특화사업", desc: "지역사회 네트워크(찾아가는 선배와의 대화) · 당사자 강연자 육성사업" },
  ],
  cta: "센터 이용 문의하기",
